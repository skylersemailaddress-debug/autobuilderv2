...
def build_run_summary(record: Dict) -> Dict:
    ...
    return {
        ...
        "control_state": record.get("control_state", {}),
        "contract_validation_passed": record.get("contract_validation_passed", False),
        "project_name": record.get("project_name"),
        "nexus_mode": record.get("nexus_mode", False),
        "approvals_enabled": record.get("approvals_enabled", False),
        "resumability_enabled": record.get("resumability_enabled", False),
