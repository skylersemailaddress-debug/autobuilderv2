...
CAPABILITY_FAMILY_MATURITY: dict[str, dict[str, object]] = {
    "chat-first": {
        ...
        "supported": ["preview", "clarification", "default_inference", "project_memory", "conversation_to_spec"],
    ...
    "agent-runtime": {
        "maturity": BOUNDED_PROTOTYPE,
        "supported": ["task_modeling", "approval_gating", "blocked_semantics", "audit_log", "replay_signature"],
    ...
    "self-extension": {
        "maturity": BOUNDED_PROTOTYPE,
        "supported": ["sandbox_generation", "validation_thresholds", "registry_activation", "quarantine", "rollback_reference"],
    ...
    "multimodal-world-state": {
        ...
        "supported": ["schema_normalization", "world_state_snapshot", "contract_metadata"],
